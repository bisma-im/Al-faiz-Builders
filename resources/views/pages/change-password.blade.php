                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">Setup New Password</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                    ...
                    <div id="kt_account_settings_change_password" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_new_password_form" class="form" data-kt-redirect="/" action="{{ route('changePassword') }}" method="POST">
                            {{-- <form id="kt_new_password_form" class="form" data-kt-redirect="/"> --}}
                            @csrf
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="password" name="current_password" class="form-control form-control-lg form-control-solid" placeholder="Current Password" value="" autocomplete="off" />
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <button type="submit" class="btn btn-primary" id="kt_new_password_submit">Save Changes</button>
                            </div>
                            <!--end::Actions-->
                        </form>
                        <!--end::Form-->
