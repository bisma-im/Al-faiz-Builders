                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                ...
                                <!--end::Export-->
                                <!--begin::Add customer-->
                                <a href="/add-user-form" class="btn btn-primary" role="button">Add User</a>
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_users_table">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('updateUserForm', ['id' => $user->id]) }}" class="text-gray-600 text-hover-primary mb-1">{{ $user->full_name }}</a>
                                    </td>
                                    <td>{{ $user->username }}</td>
                                    <td>{{ $user->email }}</td>
...
@push('scripts')
    <!--begin::Vendors Javascript(used for this page only)-->
		...
		<script src="assets/js/custom/account/settings/users-list.js"></script>
