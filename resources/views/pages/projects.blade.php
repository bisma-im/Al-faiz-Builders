...
@push('scripts')
    <!--begin::Vendors Javascript(used for this page only)-->
        ...
        <script src="{{ URL::asset('assets/js/custom/pages/listings/projects/delete-project.js') }}"></script>
        <script src="{{ URL::asset('assets/js/custom/apps/customers/add.js') }}"></script>
