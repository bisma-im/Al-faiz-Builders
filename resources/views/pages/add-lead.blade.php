            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_leads_form" class="form" data-kt-redirect="{{ route('showLeads', ['username' => session('username')]) }}" action="{{ route('addLead') }}" method="POST">
                            @csrf
                            <!--begin::Card body-->
                            ...
                            <div class="card-header border-0 pt-6">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end align-items-center d-none" data-kt-customer-table-toolbar="selected">
                                        ...
                                        <button type="button" class="btn btn-danger" data-kt-customer-table-select="delete_selected">Transfer Selected</button>
                                    </div>
                                    <!--end::Group actions-->
                                </div>
                                <!--end::Card toolbar-->
                ...
                <div class="card">
                    ...
                    <div id="kt_account_settings_deactivate" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_account_deactivate_form" class="form" data-kt-redirect="{{ route('showLeads') }}">
                            @csrf
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                <!--begin::Notice-->
