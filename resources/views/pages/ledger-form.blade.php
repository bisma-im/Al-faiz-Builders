                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">Generate Ledger</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                    ...
                    <div id="kt_new_account" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_new_account_form" class="form" action="{{ route('showLedger') }}" method="POST">
                            @csrf
                            <!--begin::Card body-->
...
@endsection
@push('scripts')
    <script src="{{ URL::asset('assets/js/custom/account/settings/ledger-form.js') }}"></script>
@endpush