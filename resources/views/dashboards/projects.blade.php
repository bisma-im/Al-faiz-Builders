                            ...
                            <div class="card-body py-9">
                                ...
                                <div class="row gx-9 h-100">
                                    ...
                                    <div class="col-sm-6 mb-10 mb-sm-0">
                                        <!--begin::Image-->
                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" style="background-size: 100% 100%;background-image:url('{{ URL::asset('assets/media/stock/600x600/img-33.jpg') }}')"></div>
                                        <!--end::Image-->
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-center h-100">
                                    ...
                                    <div class="col-5 pt-10">
                                        <!--begin::Illustration-->
                                        <div class="bgi-no-repeat bgi-size-contain bgi-position-x-end h-225px" style="background-image:url('{{ URL::asset('assets/media/svg/illustrations/easy/5.svg') }}"></div>
                                        <!--end::Illustration-->
                                    </div>
                                    <!--end::Col-->
                                </div>
