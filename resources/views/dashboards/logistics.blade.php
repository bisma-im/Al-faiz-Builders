                            ...
                            <div class="card-body d-flex flex-column flex-center">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="py-10 text-center">
                                        <img src="{{ URL::asset('assets/media/svg/illustrations/easy/3.svg') }}" class="theme-light-show w-200px" alt="" />
                                        <img src="{{ URL::asset('assets/media/svg/illustrations/easy/3-dark.svg') }}" class="theme-dark-show w-200px" alt="" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Heading-->
