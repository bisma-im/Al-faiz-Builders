        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="../../demo1/dist/apps/subscriptions/list.html" class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">My Subscriptions</a>
                        ...
                        <div class="row g-5 g-xl-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card card-flush h-xl-100" style="background-color: #F6E5CA">
                                    ...
                                    <div class="card-body text-center pt-5">
                                        <!--begin::Image-->
                                        <img src="{{ URL::asset('assets/media/svg/shapes/bitcoin.svg') }}" class="h-125px mb-5" alt="" />
                                        <!--end::Image-->
                                        <!--begin::Section-->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card card-flush h-xl-100" style="background-color: #F3D6EF">
                                    ...
                                    <div class="card-body text-center pt-5">
                                        <!--begin::Image-->
                                        <img src="{{ URL::asset('assets/media/svg/shapes/ethereum.svg') }}" class="h-125px mb-5" alt="" />
                                        <!--end::Image-->
                                        <!--begin::Section-->
                                        <div class="text-start">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card card-flush h-xl-100" style="background-color: #BFDDE3">
                                    ...
                                    <div class="card-body text-center pt-5">
                                        <!--begin::Image-->
                                        <img src="{{ URL::asset('assets/media/svg/shapes/dogecoin.svg') }}" class="h-125px mb-5" alt="" />
                                        <!--end::Image-->
                                        <!--begin::Section-->
                                        <div class="text-start">
                                    ...
                                    <div class="tab-pane fade active show" id="kt_forms_widget_1_tab_content_1">
                                        ...
                                        <div class="form-floating border border-gray-300 rounded mb-7">
                                            <select class="form-select form-select-transparent" id="kt_forms_widget_1_select_1">
                                                <option></option>
                                                <option value="0" data-kt-select2-icon="{{ URL::asset('assets/media/svg/coins/bitcoin.svg') }}" selected="selected">Bitcoin/BTC</option>
                                                <option value="1" data-kt-select2-icon="{{ URL::asset('assets/media/svg/coins/ethereum.svg') }}">Ethereum/ETH</option>
                                                <option value="2" data-kt-select2-icon="{{ URL::asset('assets/media/svg/coins/filecoin.svg') }}">Filecoin/FLE</option>
                                                <option value="3" data-kt-select2-icon="{{ URL::asset('assets/media/svg/coins/chainlink.svg') }}">Chainlink/CIN</option>
                                                <option value="4" data-kt-select2-icon="{{ URL::asset('assets/media/svg/coins/binance.svg') }}">Binance/BCN</option>
                                            </select>
