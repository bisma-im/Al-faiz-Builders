                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/210.gif') }}" class="w-50px" alt="" />
                                                </td>
                                                <td class="ps-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/215.gif') }}" class="w-50px" alt="" />
                                                </td>
                                                <td class="ps-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/209.gif') }}" class="w-50px" alt="" />
                                                </td>
                                                <td class="ps-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/214.gif') }}" class="w-50px" alt="" />
                                                </td>
                                                <td class="ps-0">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/flags/united-states.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Section-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/flags/brazil.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Section-->
                                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                            <!--begin::Content-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/flags/turkey.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Section-->
                                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                            <!--begin::Content-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/flags/france.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Section-->
                                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                            <!--begin::Content-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/flags/india.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Section-->
                                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                            <!--begin::Content-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/flags/sweden.svg') }}" class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Section-->
                                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                            <!--begin::Content-->
                    ...
                    <div class="col-xl-4 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/dribbble-icon-1.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/linkedin-1.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/slack-icon.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/youtube-3.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/instagram-2-1.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/facebook-3.svg') }}" class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                    <!--begin::Section-->
                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                        <!--begin::Content-->
